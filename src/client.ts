...
import { ExtractionTemplatesResource } from "./resources/extraction-templates.js";
...
export class Knowledge2 extends BaseClient {
  ...
  private _extractionTemplates: ExtractionTemplatesResource | undefined;
  ...
  /** Extraction template management (preview). */
  get extractionTemplates(): ExtractionTemplatesResource {
    return (this._extractionTemplates ??= new ExtractionTemplatesResource(this));
  }
